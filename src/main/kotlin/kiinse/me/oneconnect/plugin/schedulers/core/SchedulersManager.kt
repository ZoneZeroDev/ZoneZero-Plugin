package kiinse.me.oneconnect.plugin.schedulers.core

import kiinse.me.oneconnect.plugin.OneConnect
import kiinse.me.oneconnect.plugin.exceptions.SchedulerException
...
import kiinse.me.oneconnect.plugin.schedulers.interfaces.MineSchedulersManager
...
class SchedulersManager : MineSchedulersManager {
    ...
    override fun register(scheduler: Scheduler): MineSchedulersManager {
        ...
        OneConnect.sendLog(Level.CONFIG, "Scheduler '&d${scheduler.name}&6' by plugin '&d${scheduler.plugin.name}&6' has been registered!")
        scheduler.start()
        return this
    }
    ...
    override fun unregister(scheduler: Scheduler): MineSchedulersManager {
        ...
        OneConnect.sendLog(Level.CONFIG, "Scheduler '&d${scheduler.name}&6' by plugin '&d${scheduler.plugin.name}&6' has been unregistered!")
        return this
    }
