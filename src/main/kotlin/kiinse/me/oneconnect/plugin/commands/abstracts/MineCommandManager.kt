package kiinse.me.oneconnect.plugin.commands.abstracts
...
import kiinse.me.oneconnect.plugin.commands.core.CommandFailureHandler
...
@Suppress("UNUSED")
abstract class MineCommandManager protected constructor(protected val plugin: OneConnect) : CommandExecutor {
    ...
    protected fun register(commandClass: MineCommand, method: Method, pluginCommand: PluginCommand?,
        ...
        OneConnect.sendLog(Level.CONFIG, "Command '&d$command&6' registered!")
    }
