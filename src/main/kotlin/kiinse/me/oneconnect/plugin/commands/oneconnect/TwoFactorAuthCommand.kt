...
import kiinse.me.oneconnect.plugin.service.enums.QueryType
import kiinse.me.oneconnect.plugin.utils.MessageUtils
import org.bukkit.command.CommandSender
import org.bukkit.entity.Player
import java.util.regex.Pattern

class TwoFactorAuthCommand(plugin: OneConnect, private val playersData: PlayersData) : MineCommand(plugin) {
    ...
    @Command(command = "2fa", permission = "oneconnect.player.2fa", parameters = 1, disallowNonPlayer = true)
    ...
    @SubCommand(command = "help", permission = "oneconnect.player.2fa", disallowNonPlayer = true)
    fun help(context: MineCommandContext) {
        messageUtils.sendMessage(context.sender, "&d=========== &6&l[&bOneConnect&6&l] &d===========\n", Message.TWO_FACTOR_HELP)
    }

    @SubCommand(command = "enable", permission = "oneconnect.player.2fa", parameters = 3, disallowNonPlayer = true)
    ...
    @SubCommand(command = "disable", permission = "oneconnect.player.2fa", parameters = 1, disallowNonPlayer = true)
