...
interface MineSchedulersManager {
    ...
    fun register(scheduler: Scheduler): MineSchedulersManager
    @Throws(SchedulerException::class)
    fun startScheduler(scheduler: Scheduler): MineSchedulersManager
    @Throws(SchedulerException::class)
    fun stopScheduler(scheduler: Scheduler): MineSchedulersManager
    ...
    @Throws(SchedulerException::class)
    fun unregister(scheduler: Scheduler): MineSchedulersManager
