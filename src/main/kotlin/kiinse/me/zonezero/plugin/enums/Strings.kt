...
enum class Strings(val value: String) {
    ...
    MESSAGES_MISMATCH_MESSAGE("Version mismatch found for dir '&c<FILE>&6'. This dir has been renamed to '&c<OLD_FILE>&6' and a new dir '&c<FILE>&6' has been created"),
    NEW_TML_VERSION_COPY_ERROR("An error occurred while copying the new version of the file '&c<FILE>&6'! Message:"),
    NEW_MESSAGES_VERSION_COPY_ERROR("An error occurred while copying the new version of the dir '&c<FILE>&6'! Message:"),
